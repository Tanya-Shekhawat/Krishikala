...
<body>
    <header>
        <h1 style="font-size: 1rem; background-color: black);">Appointment From Bhopal Hospital</h1>
        <address>
            <br>
            <h2 style="font-size: 1.6rem; font-weight: bold; color: black;"><br>Hospital Head <br> Near Something
                something, MP Nagar<br> +91 7489254540 </h2>
        </address>
        <br>
        <span style="width: 25%;"><img alt="" src="assets/img/h1.png"></span>
    </header>
