...
@section('main_content')
    <style>
        .breadcam_bg-green {
            background-image: url({{asset('assets/assets/img/fertilizer.png')}});
        }
    ...
    <h6
        ...
        text-align: center;
    ">
        <b>Identify Your Suitable Fertilizer For Crop</b>
    </h6>
    <center>
        ...
        <br />
        <a href="https://fertilizer-predictor.onrender.com//">
